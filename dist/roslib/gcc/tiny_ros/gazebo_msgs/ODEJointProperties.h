...
namespace gazebo_msgs
{
  ...
  class ODEJointProperties : public tinyros::Msg
  {
    ...
    virtual std::string echo()
    {
      ...
      std::stringstream ss_hiStopi; ss_hiStopi << "{\"hiStop" << i <<"\": " << hiStop[i] <<"}";
      ...
      std::stringstream ss_loStopi; ss_loStopi << "{\"loStop" << i <<"\": " << loStop[i] <<"}";
      ...
      for( uint32_t i = 0; i < erp_length; i++){
      if( i == (erp_length - 1)) {
      std::stringstream ss_erpi; ss_erpi << "{\"erp" << i <<"\": " << erp[i] <<"}";
      ...
      for( uint32_t i = 0; i < cfm_length; i++){
      if( i == (cfm_length - 1)) {
      std::stringstream ss_cfmi; ss_cfmi << "{\"cfm" << i <<"\": " << cfm[i] <<"}";
      ...
      std::stringstream ss_stop_erpi; ss_stop_erpi << "{\"stop_erp" << i <<"\": " << stop_erp[i] <<"}";
      ...
      std::stringstream ss_stop_cfmi; ss_stop_cfmi << "{\"stop_cfm" << i <<"\": " << stop_cfm[i] <<"}";
      ...
      std::stringstream ss_fudge_factori; ss_fudge_factori << "{\"fudge_factor" << i <<"\": " << fudge_factor[i] <<"}";
      ...
      for( uint32_t i = 0; i < fmax_length; i++){
      if( i == (fmax_length - 1)) {
      std::stringstream ss_fmaxi; ss_fmaxi << "{\"fmax" << i <<"\": " << fmax[i] <<"}";
      ...
      for( uint32_t i = 0; i < vel_length; i++){
      if( i == (vel_length - 1)) {
      std::stringstream ss_veli; ss_veli << "{\"vel" << i <<"\": " << vel[i] <<"}";
