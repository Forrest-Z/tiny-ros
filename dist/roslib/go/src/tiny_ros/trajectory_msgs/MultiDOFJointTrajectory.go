...
type MultiDOFJointTrajectory struct {
    ...
    Go_points []trajectory_msgs.MultiDOFJointTrajectoryPoint `json:"points"`
}
...
func NewMultiDOFJointTrajectory() (*MultiDOFJointTrajectory) {
    ...
    newMultiDOFJointTrajectory.Go_points = []trajectory_msgs.MultiDOFJointTrajectoryPoint{}
...
func (self *MultiDOFJointTrajectory) Go_deserialize(buff []byte) (int) {
    ...
    offset += 4
    self.Go_points = make([]trajectory_msgs.MultiDOFJointTrajectoryPoint, length_points, length_points)
    for i := 0; i < length_points; i++ {
...
func (self *MultiDOFJointTrajectory) Go_echo() (string) { return "" }
