...
type DiagnosticStatus struct {
    ...
    Go_values []diagnostic_msgs.KeyValue `json:"values"`
}

func (self *DiagnosticStatus) Go_OK() (byte) { return 0 }
func (self *DiagnosticStatus) Go_WARN() (byte) { return 1 }
func (self *DiagnosticStatus) Go_ERROR() (byte) { return 2 }
func (self *DiagnosticStatus) Go_STALE() (byte) { return 3 }
func NewDiagnosticStatus() (*DiagnosticStatus) {
    ...
    newDiagnosticStatus.Go_values = []diagnostic_msgs.KeyValue{}
...
func (self *DiagnosticStatus) Go_deserialize(buff []byte) (int) {
    ...
    offset += 4
    self.Go_values = make([]diagnostic_msgs.KeyValue, length_values, length_values)
    for i := 0; i < length_values; i++ {
