...
func (self *Log) Go_DEBUG() (byte) { return 1  }
func (self *Log) Go_INFO() (byte) { return 2   }
func (self *Log) Go_WARN() (byte) { return 4   }
func (self *Log) Go_ERROR() (byte) { return 8  }
func (self *Log) Go_FATAL() (byte) { return 16  }
func NewLog() (*Log) {
    newLog := new(Log)
...
func (self *Log) Go_deserialize(buff []byte) (int) {
    ...
    offset += 4
    self.Go_topics = make([]string, length_topics, length_topics)
    for i := 0; i < length_topics; i++ {
