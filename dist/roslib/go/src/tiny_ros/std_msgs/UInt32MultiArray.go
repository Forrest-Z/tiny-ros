...
func NewUInt32MultiArray() (*UInt32MultiArray) {
    ...
    newUInt32MultiArray.Go_layout = std_msgs.NewMultiArrayLayout()
...
func (self *UInt32MultiArray) Go_deserialize(buff []byte) (int) {
    ...
    offset += 4
    self.Go_data = make([]uint32, length_data, length_data)
    for i := 0; i < length_data; i++ {
...
func (self *UInt32MultiArray) Go_echo() (string) { return "" }
