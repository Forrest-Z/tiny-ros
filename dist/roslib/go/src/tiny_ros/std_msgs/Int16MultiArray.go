...
func NewInt16MultiArray() (*Int16MultiArray) {
    ...
    newInt16MultiArray.Go_layout = std_msgs.NewMultiArrayLayout()
...
func (self *Int16MultiArray) Go_deserialize(buff []byte) (int) {
    ...
    offset += 4
    self.Go_data = make([]int16, length_data, length_data)
    for i := 0; i < length_data; i++ {
...
func (self *Int16MultiArray) Go_echo() (string) { return "" }
