...
func (self *GetPhysicsPropertiesRequest) Go_echo() (string) { return "" }
...
func NewGetPhysicsPropertiesResponse() (*GetPhysicsPropertiesResponse) {
    ...
    newGetPhysicsPropertiesResponse.Go_ode_config = gazebo_msgs.NewODEPhysics()
...
func (self *GetPhysicsPropertiesResponse) Go_serialize(buff []byte) (int) {
    ...
    offset += 8
    buff[offset + 0] = byte((self.Go_pause >> (8 * 0)) & 0xFF)
    offset += 1
...
func (self *GetPhysicsPropertiesResponse) Go_deserialize(buff []byte) (int) {
    ...
    offset += 8
    self.Go_pause = bool((buff[offset + 0] & 0xFF) << (8 * 0))
    offset += 1
...
func (self *GetPhysicsPropertiesResponse) Go_echo() (string) { return "" }
