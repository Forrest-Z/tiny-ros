...
func (self *ContactsState) Go_deserialize(buff []byte) (int) {
    ...
    offset += 4
    self.Go_states = make([]gazebo_msgs.ContactState, length_states, length_states)
    for i := 0; i < length_states; i++ {
...
func (self *ContactsState) Go_echo() (string) { return "" }
