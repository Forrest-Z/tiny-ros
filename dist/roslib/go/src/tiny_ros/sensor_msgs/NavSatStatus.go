...
func (self *NavSatStatus) Go_STATUS_NO_FIX() (int8) { return   -1         }
func (self *NavSatStatus) Go_STATUS_FIX() (int8) { return       0         }
func (self *NavSatStatus) Go_STATUS_SBAS_FIX() (int8) { return  1         }
func (self *NavSatStatus) Go_STATUS_GBAS_FIX() (int8) { return  2         }
func (self *NavSatStatus) Go_SERVICE_GPS() (uint16) { return      1 }
func (self *NavSatStatus) Go_SERVICE_GLONASS() (uint16) { return  2 }
func (self *NavSatStatus) Go_SERVICE_COMPASS() (uint16) { return  4       }
func (self *NavSatStatus) Go_SERVICE_GALILEO() (uint16) { return  8 }
